        ...
        <div class="container about-container">
            ...
            <div class="about-grid">
                ...
                <div>
                    ...
                    <!-- Description -->
                    <div
                        class="mt-6 space-y-5 text-slate-600 
                ...
                <div class="relative group">
                    ...
                    <!-- Decorative Shape -->
                    <div
                        class="absolute -top-5 -left-5 w-24 h-24 
                            border-t-4 border-l-4 border-amber-500 
                            rounded-tl-3xl">
                    </div>

                    <div
                        class="absolute -bottom-5 -right-5 w-24 h-24 
                    ...
                    <div class="relative overflow-hidden rounded-2xl shadow-2xl">
                        ...
                        <img src="{{ asset('asset/navbar/about.png') }}" alt="Department of Mathematics"
                        ...
                        <div class="absolute bottom-0 left-0 right-0 p-6 sm:p-8">
                            ...
                            <span
                                class="text-xs sm:text-sm tracking-[0.25em]
